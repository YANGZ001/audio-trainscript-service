...
Defines how the service resolves `b23.tv` short URLs to canonical `bilibili.com` URLs before BVID extraction, enabling callers to pass either URL form to `POST /api/transcribe`.
