...
- **Phased Scope Split**:
  - **Immediate Goal**: Focus on implementing the Bilibili ASR fallback using Google's Gemini 1.5 Flash API (free tier). The service will remain stateless for this phase, deleting audio files immediately after completing transcription.
